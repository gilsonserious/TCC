...
export class AuthGuard implements CanActivate {
  ...
  constructor(public firestore: AngularFirestore,private authService: AuthService, private _router: Router, private afAuth: AngularFireAuth) {
  }
  ...
  verificarErro(errorCode: String) {
    switch (errorCode) {
